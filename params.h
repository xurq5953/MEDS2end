...
#define TRINE_RESPONSE_BYTES MEDS_CEIL_DIV((MEDS_K * MEDS_n * Fq_bits), 8)
...
#define MEDS_PK_BYTES TRINE_PK_BYTES
#define MEDS_SK_BYTES TRINE_SK_BYTES
#define MEDS_SIG_BYTES TRINE_SIG_BYTES
